...
class TestNX9KConnection(CondoorTestCase):
    ...
    def test_NX9K_1_discovery(self):
        ...
        self.assertEqual(conn.family, "Nexus9000", "Wrong Family: {}".format(conn.family))
        ...
        self.assertEqual(conn.os_version, "7.0(3)I5(1)", "Wrong Version: {}".format(conn.os_version))
    ...
    def test_NX9K_2_rediscovery(self):
    ...
    def test_NX9K_3_connection_wrong_user(self):
    ...
    def test_NX9K_4_connection_refused(self):
